...
void HAL_ETH_MspInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspInit 0 */
    ...
    PG13     ------> ETH_TXD0
    */
    GPIO_InitStruct.Pin = RMII_RXD1_Pin|RMII_TX_EN_Pin|RMII_TXD0_Pin;
    ...
    GPIO_InitStruct.Pin = RMII_TXD1_Pin|RMII_MDC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF11_ETH;
...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    PG13     ------> ETH_TXD0
    */
    HAL_GPIO_DeInit(GPIOC, RMII_RXD1_Pin|RMII_TX_EN_Pin|RMII_TXD0_Pin);

    HAL_GPIO_DeInit(GPIOA, RMII_REF_CLK_Pin|RMII_MDIO_Pin|RMII_CRS_DV_Pin);

    HAL_GPIO_DeInit(RMII_RXD0_GPIO_Port, RMII_RXD0_Pin);

    HAL_GPIO_DeInit(GPIOG, RMII_TXD1_Pin|RMII_MDC_Pin);
