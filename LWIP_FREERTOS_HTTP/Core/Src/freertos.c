...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(httpServerTask, HttpServerTask, osPriorityNormal, 0, 512);
...
/* USER CODE BEGIN Header_HttpServerTask */
/**
* @brief Function implementing the httpServerTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_HttpServerTask */
void HttpServerTask(void const * argument)
{
